...
/*#__PURE__*/
function () {
  var _ref9 = (0, _asyncToGenerator2.default)(function* (starter, options = {}) {
    ...
    if (!isValid(rootPath)) {
      report.panic(`Could not create a project in "${sysPath.resolve(rootPath)}" because it's not a valid path`);
      return;
    }
